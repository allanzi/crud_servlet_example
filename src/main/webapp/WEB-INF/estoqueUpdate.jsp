                ...
                <form name="form-estoque" action="#" method="POST" class="col s12" accept-charset="UTF-8">
                    <div class="row">
                        ...
                        <div class="input-field col s12 m12 l6">
                            ...
                            <input name="nome" id="nome" type="text" class="validate" required="required" maxlength="150" value="${estoque.getNome()}">
                        </div>
                        
                        <div class="input-field col s12 m12 l6">
                            <label for="descricao">Descrição</label>
                            <input name="descricao" id="descricao" type="text" class="validate" required="required" maxlength="150" value="${estoque.getDescricao()}">
                        </div>
                        
                        
                        <div class="input-field col s12 m12 l4">
                            <label for="preco_compra">Preço de compra</label>
                            <input name="preco_compra" id="preco_compra" type="number" class="validate" required="required" data-mask="000.000,00" value="${estoque.getPreco_compra()}">
                        </div>
                        
                        <div class="input-field col s12 m12 l4">
                            <label for="preco_venda">Preço de venda</label>
                            <input name="preco_venda" id="preco_venda" type="number" class="validate" required="required" data-mask="000.000,00" value="${estoque.getPreco_venda()}">
                        </div>
                        
                        <div class="input-field col s12 m4 l4">
                            <label for="quantidade">Quant. Estoque</label>
                            <input name="quantidade" id="quantidade" type="number" class="validate" required="required" maxlength="6" value="${estoque.getQuantidade()}">
                        </div>
